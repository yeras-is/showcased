...
import 'dart:async';
import 'package:showcased/custom_paint.dart';
...
class _ShowcaseState extends State<Showcase> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AnchoredOverlay(
      overlayBuilder: (BuildContext context, Rect rectBound, Offset offset) => buildOverlayOnTarget(offset, rectBound.size, rectBound, size),
      showOverlay: true,
      child: widget.child,
    );
  }
              ...
              child: Container(
                ...
                child: CustomPaint(
                  painter: ShapePainter(
                      opacity: widget.overlayOpacity, rect: position!.getRect(), shapeBorder: widget.shapeBorder, color: widget.overlayColor),
                ),
              ),
            ),
            _TargetWidget(
